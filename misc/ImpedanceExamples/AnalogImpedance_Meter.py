...
print("Reference: "+str(reference)+" Ohm  Frequency: "+str(frequency/1e3)+" kHz for nanofarad capacitors")
...
dwf.FDwfAnalogImpedanceFrequencySet(hdwf, c_double(frequency)) # frequency in Hertz
